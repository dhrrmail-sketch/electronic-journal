(() => {
const TEST_BETA_VERSION = "2.0.0-beta.39";
...
function testLinkData() {
  ...
  return {
    ...
    appearance: packed.appearance || null
  };
}
...
window.TestBeta = {
  ...
  TEST_MAIL_TEMPLATES_KEY, TEST_PUBLIC_URL_KEY, FONT_KEY, FONT_FAMILIES, appearanceSettings, applyAppearance
};
})();
